#!/usr/bin/env bash
# build-bundle.sh — produce a portable Plexus install bundle.
#
# Per Task #284 / PLAN-PLEXUS-INSTALL-BUNDLE.md. Run on the build-host
# (devel) to produce dist/plexus-install-bundle-<sha>-<timestamp>/ which
...
# Produces: dist/plexus-install-bundle-<yaklog-sha-short>-<utc>/
...
BUNDLE_NAME="plexus-install-bundle-${YAKLOG_SHA}-${UTC_TIMESTAMP}"
